              ...
              <div class="row">
                  ...
                  <div class="col-lg-8 col-md-4 col-sm-12 col-xs-12">
                      <div class="navigation">
                          <div id="navigation">
                              <ul>
                                  <li class="active"><router-link to="/"> 홈 </router-link></li>                                
                                  <li class="has-sub"><a href="#">학생회 소개</a>
                                      <ul>
                                        <li><router-link :to="{ name: 'Organ'}"> 학생회 조직도 </router-link></li>
                                        <li><router-link :to="{ name: 'PostViewer', query: { id: 72 } }"> 학칙 </router-link></li>
                                      </ul>
                                  </li>
                                  <li class="has-sub"><a href="#">게시판</a>
                                      <ul>
                                        <li><router-link :to="{ name: 'Board', query: { boardId: 6 } }"> 공지사항 </router-link></li>
                                        <li><router-link :to="{ name: 'Board', query: { boardId: 1 } }"> FAQ </router-link></li>
                                        <li><router-link :to="{ name: 'Board', query: { boardId: 2 } }"> 건의게시판 </router-link></li>
                                        <li><router-link :to="{ name: 'Board', query: { boardId: 4 } }"> 회의록 </router-link></li>
                                        <li><router-link :to="{ name: 'Board', query: { boardId: 5 } }"> 결산내역 </router-link></li>
                                      </ul>
                                  </li>
                                  <li><router-link :to="{ name: 'Rental'}"> 대여장부 </router-link></li>
                                  <li><a href="#" title="Contact Us">메뉴2</a> </li>
                                  <li><a href="#" title="Styleguide">메뉴3</a> </li>
                              </ul>
                          </div>
                      </div>
